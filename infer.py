...
add_arg('image_size',        int,   178,               "image size")
add_arg('load_height',        int,   178,               "image size")
add_arg('load_width',        int,   178,               "image size")
add_arg('crop_height',        int,   178,               "height of crop size")
...
add_arg('n_samples',        int,   1,                "batch size when test")
